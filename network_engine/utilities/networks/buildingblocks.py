...
# TODO Fix from here
# TODO: figure out what I use this for, better name? NontrainableVariableModule
class ConstantVariableModule(VariableModule):
  ...
  Was called ConstantVariableModule in earlier implementations.
  """
...
# TODO: Do we use Crop-Module for anything? Otherwise deprecate it
...
# TODO: Delete this class, it just replicates the functionality of the module above
...
# TODO: ActivationModule and Loss Module are the same operation? Find a more generic name
# SingleInputFunctionModule
# DualInputFunctionModule
